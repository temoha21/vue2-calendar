...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  watch: {
    ...
    enabledDays: function enabledDays() {
      this.getDateRange();
    }
  },
  computed: {
  ...
  methods: {
    ...
    stringify: function stringify(date) {
      ...
      var weekDay = this.parseDay(date);
      var monthName = this.parseMonth(date);
      return format.replace(/yyyy/g, year).replace(/MMMM/g, monthName).replace(/MMM/g, monthName.substring(0, 3)).replace(/MM/g, ('0' + month).slice(-2)).replace(/dd/g, ('0' + day).slice(-2)).replace(/yy/g, year).replace(/M(?!a)/g, month).replace(/d/g, day).replace(/l/g, weekDay);
    },
      ...
      for (var p = 0; p < this.pane; p++) {
        ...
        if (firstDayWeek > 1) {
          ...
          var _loop = function _loop(_i) {
            ...
            var formatedDate = time.year + '-' + (time.month < 10 ? '0' + (time.month + 1) : time.month + 1) + '-' + (dayText < 10 ? '0' + dayText : dayText);
            var sclassF = 'datepicker-item-disable';
            if (_this2.enabledDays.find(function (el) {
        ...
        var _loop2 = function _loop2(_i2) {
          ...
          var formatedDate = time.year + '-' + (time.month < 10 ? '0' + (time.month + 1) : time.month + 1) + '-' + (_i2 < 10 ? '0' + _i2 : _i2);
          var sclassAll = 'datepicker-item-disable';
          if (_this2.enabledDays.find(function (el) {
            return formatedDate === el;
          })) {
            sclassAll = '';
        ...
        if (this.dateRange[p].length < 42) {
          ...
          var _loop3 = function _loop3(_i3) {
            var formatedDate = time.year + '-' + (time.month < 10 ? '0' + (time.month + 1) : time.month + 1) + '-' + (_i3 < 10 ? '0' + _i3 : _i3);
            var sclassL = 'datepicker-item-disable';
            if (_this2.enabledDays.find(function (el) {
              return formatedDate === el;
            })) {
              sclassL = '';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Calendar_vue__ = __webpack_require__(28);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a0cabcd4_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Calendar_vue__ = __webpack_require__(75);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a0cabcd4_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Calendar_vue__["a" /* default */],
